...
import com.edu.kygroup.ui.FindPasswordStep.onNextListener;
...
public class FindPasswordActivity extends BaseActivity implements
	...
	private FindStep1 step1;
	private FindStep2 step2;
	private FindStep3 step3;
	...
	private FindPasswordStep initStep() {
		...
		case 1:
			if (step1 == null) {
				step1 = new FindStep1(this, mVfFlipper.getChildAt(0));
			}
			return step1;
		case 2:
			if (step2 == null) {
				step2 = new FindStep2(this, mVfFlipper.getChildAt(1));
			}
			mHandler.sendEmptyMessage(0);
			return step2;
		case 3:
			if (step3 == null) {
				step3 = new FindStep3(this, mVfFlipper.getChildAt(2));
			}
			return step3;
		default:
			break;
