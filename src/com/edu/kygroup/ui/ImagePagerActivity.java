...
import com.edu.kygroup.ui.ImageDetailFragment.OnBack;
import com.edu.kygroup.utils.Constant;
import com.edu.kygroup.utils.SaveImageTask;
import com.edu.kygroup.utils.SaveImageTask.SaveImge;
import com.edu.kygroup.utils.ToastUtils;
import com.edu.kygroup.widget.HackyViewPager;
...
public class ImagePagerActivity extends FragmentActivity implements OnBack,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		pagerPosition = getIntent().getIntExtra(Constant.EXTRA_IMAGE_INDEX, 0);
		lists = (List<String>) getIntent().getExtras().getSerializable(
				Constant.EXTRA_IMAGE_URLS);
		...
		if (savedInstanceState != null) {
			pagerPosition = savedInstanceState.getInt(Constant.STATE_POSITION);
		}
